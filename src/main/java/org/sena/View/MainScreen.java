...
import org.sena.Database.Books;
import org.sena.Database.BooksManager;
import org.sena.Database.BorrowBookManager;
...
public class MainScreen extends ViewAlert implements Initializable
{
    ...
    public int addBookClick(ActionEvent event)
    {
        try{
            ...
            alertError("Hata!", "Sayfa sayısı yanlış girildi!");
            return 0;
        }
        if(comboBoxType.getValue().equals("Türü") || textBookName.getText().equals("") || textAuthorName.getText().equals("") || textNumberOfPage.getText().equals("") || textAdminUserName.getText().equals("") || textAdminPassword.getText().equals("")) {
            alertInformation("Eksik Giriş!", "Lütfen bilgilerinizi kontrol ediniz!");
        }
        else if(textAdminUserName.getText().equals("Admin") && textAdminPassword.getText().equals("123456"))
        {
            ...
            alertInformation("Başarılı!", "Eklendi");
            ...
            alertError("Hata!", "Hatalı veya Eksik Giriş!!!");
        }
        return 0;
    }
    ...
    public void borrowBook(ActionEvent event)
    {
        ...
        if(control1==0 && control2.equals("YOK") && Login.nowUserName.equals(textBorrowUserName.getText()))
        {
            ...
            alertInformation("Ödünç alma", "Başarılı");
            ...
            if(control1 == 1) {
                alertError("GİRİŞ BİLGİLERİ HATALI!", "Böyle Bir Kitap Bulunmamaktadır.");
            }
            else if(!control2.equals("YOK")) {
                alertError("FAIL!", "Halihazırda ödünç aldığınız bir kitap var");
            }
            else if(!Login.nowUserName.equals(textBorrowUserName.getText())) {
                alertError("FAIL!", "Kullanıcı adı hatalı");
            }
        }
    }
    ...
    public void returnBook(ActionEvent event)
    {
        ...
        {
            borrowBookManager.returnBook(textReturnBookName.getText().toUpperCase());
            alertInformation("SUCCESS!", "Kitap geri verildi");
            ...
            if(control == 1){
                alertError("HATA!", "Böyle Bir Kitap Ödünç Alınmamış");
            }
            else if(!Login.nowUserName.equals(textReturnUserName.getText())) {
                alertError("HATA!", "Hatalı Kullanıcı Adı Girişi");
            }
        }
    }
